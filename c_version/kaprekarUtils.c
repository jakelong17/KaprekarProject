...
int isKaprekar(int n) {
  ...
  */
  ...
  // changed i=1 to i=0 and added +1 to run for loop one more time
  for(i=0; i<=numDigits+1; i++) {
    //increase the modulus by a factor of 10
    modulus *= 10;
/** changed modulous to modulus and set value equal to 1 to make it true
changed variable numberOfDigits to numDigits
*/
